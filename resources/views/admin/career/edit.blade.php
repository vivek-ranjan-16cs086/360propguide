                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{route('career.update')}}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" value="{{base64_encode($career->id)}}">
                            <div class="row">
                                <div class="col-sm-12 col-lg-6 mb-4">
                                    <label for="title">Position</label>
                                    <input class="form-control input @error('position') is-invalid @enderror " type="text"
                                        placeholder="Enter Position" value="{{old('position') ? old('position') : $career->position}}" name="position" required>
                                </div>
                                <div class="col-sm-12 col-lg-6 mb-4">
                                    <label for="experience">Experience</label>
                                    <input class="form-control input @error('experience') is-invalid @enderror "
                                        type="text" placeholder="Enter Blog Experience"
                                        value="{{old('experience') ? old('experience') : $career->experience}}" name="experience" required>
                                </div>
                                ...
                                <div class="col-sm-12 col-lg-6 mb-4">
                                    ...
                                    <input
                                        ...
                                        value="{{old('open_positions') ? old('open_positions') : $career->open_positions}}" name="open_positions"
                                        required>
                                </div>
                                <div class="col-sm-12 col-lg-6 mb-4">
                                    ...
                                    <input
                                        ...
                                        value="{{old('location') ? old('location') : $career->location}}" name="location" required>
                                </div>
                                <div class="col-sm-12 col-lg-6 mb-4">
                                    ...
                                    <input
                                        ...
                                        value="{{old('date_posted') ? old('date_posted') : $career->date_posted}}" name="date_posted" required>
                                </div>
                                <div class="col-sm-12 col-lg-6 mb-4">
                                ...
                                <div class="col-sm-12 col-lg-6 mt-3">
                                    <div class="form-group">
										...
										{{old('job_description') ? old('job_description') : $career->job_description}}
										</textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-lg-6 d-flex mb-4">
                                    ...
                                    <div class="fileInput">
                                        <img src="{{url('storage/'.$career->company_logo)}}" alt="photo" id="previewCompanyLogo">
                                    </div>
                                </div>
