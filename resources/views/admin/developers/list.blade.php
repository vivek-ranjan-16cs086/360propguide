		...
		<div class="card contentCard">
			<div class="card-body table-responsive">
				...
				<table class="table table-striped table-bordered table_data dataex-html5-export dataTable no-footer" id="table_data" role="grid" aria-describedby="table_data_info">
					<a class="btn btn-primary pt-2 float-right" href="{{route('developers.add')}}" target="_blank">
						<span class="fa fa-plus"></span> Add New
					</a>
					<thead class="">
						<tr>
							<th style="min-width:40px">SI No.</th>
							<th style="min-width:80px">Developer Name</th>
							{{-- <th style="min-width:200px;">Developer Images</th> --}}
							{{-- <th style="min-width:200px">Status</th> --}}
							<th style="min-width:80px">Uploaded At</th>
...
<script>
    ...
    function loadAjaxList(from_date = '', to_date = ''){
         $("#table_data").DataTable({
            ...
            ajax: {
				url: "{{ route('developers.ajax-list') }}",
				type: 'GET',
				data: function(d) {
