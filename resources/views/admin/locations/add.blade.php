                        ...
                        <form method="POST" action="{{route('locations.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-lg-6 mb-4">
                                    ...
                                    <small class="text-muted">Leave empty for a city. Choose a city to create a
                                        sublocation.</small>
                                </div>

                                <div class="col-sm-12 col-lg-6 mb-4">
                                    <label for="city">Location Name</label>
                                    <input class="form-control input @error('city') is-invalid @enderror" type="text"
                                        placeholder="e.g. Noida or Sector 150" value="{{ old('city') }}" name="city"
                                        required>
                                </div>

                                <div class="col-sm-12 col-lg-6 mb-4">
                                    <label for="country">Country</label>
                                    <input class="form-control input" type="text" value="{{ old('country', 'India') }}"
                                        name="country" required>
                                </div>

                                <div class="col-sm-12 col-lg-6 mb-4">
                                    <label for="state">State</label>
                                    <input class="form-control input" type="text" placeholder="e.g. Uttar Pradesh"
                                        value="{{ old('state') }}" name="state">
                                </div>

                                <div class="col-sm-12 col-lg-6 mb-4">
                                    <label for="latitude">Latitude</label>
                                    <input class="form-control input" type="text" value="{{ old('latitude') }}"
                                        name="latitude">
                                </div>

                                <div class="col-sm-12 col-lg-6 mb-4">
                                    <label for="longitude">Longitude</label>
                                    <input class="form-control input" type="text" value="{{ old('longitude') }}"
                                        name="longitude">
                                </div>
                                <div class="col-sm-12 col-lg-6 mb-4">
                                    <label for="slug">Slug</label>
                                    <input class="form-control input" type="text" value="{{ old('slug') }}" name="slug">
                                </div>
