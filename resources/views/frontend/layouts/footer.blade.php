                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="footer-brand-wrap d-flex flex-column flex-sm-row align-items-sm-center gap-3">
                            <a href="{{ url('/') }}" class="footer-logo-link">
                                <img src="{{ url('frontend/360logo.webp') }}" alt="360 PropGuide"
                                    class="footer-logo-img" width="180" height="70" loading="lazy" decoding="async">
                            </a>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="footer-widget widget-about">
                        ...
                        <p class="footer-bio-text">
                            <strong>360 PropGuide</strong> redefines property buying in Delhi NCR with a transparent,
                            advisory-first approach. From property selection and site visits to home loans, legal due
                            diligence, and turnkey interiors, our expert advisors ensure your home buying journey is
                            seamless and rewarding.
                        </p>
                        <div class="footer-social-wrap mt-4">
                            <h5 class="social-heading">Connect With Us</h5>
                            <div class="footer-social-icons">
                                <a href="https://www.facebook.com/360propguide/" target="_blank"
                                    rel="noopener noreferrer" class="social-icon-btn facebook" title="Facebook">
                                    <i class="fa-brands fa-facebook-f"></i>
                                </a>
                                <a href="https://www.instagram.com/360propguideofficial/" target="_blank"
                                    rel="noopener noreferrer" class="social-icon-btn instagram" title="Instagram">
                                    <i class="fa-brands fa-instagram"></i>
                                </a>
                                <a href="https://www.linkedin.com/company/360propguide/" target="_blank"
                                    rel="noopener noreferrer" class="social-icon-btn linkedin" title="LinkedIn">
                                    <i class="fa-brands fa-linkedin-in"></i>
                                </a>
                                <a href="https://wa.me/+919643020020" target="_blank" rel="noopener noreferrer"
                                    class="social-icon-btn whatsapp" title="WhatsApp">
                                    <i class="fa-brands fa-whatsapp"></i>
                                </a>
                                <a href="https://www.youtube.com/@360_Propguide" target="_blank"
                                    rel="noopener noreferrer" class="social-icon-btn youtube" title="YouTube">
                    ...
                    <div class="footer-widget widget-links">
                        ...
                        <ul class="footer-menu-list">
                            ...
                            <li><a href="{{ url('/projects/jindal-sons-epic') }}"><i
                                        class="fa-solid fa-chevron-right"></i> Jindal Sons Epic</a></li>
                            <li><a href="{{ url('/projects/godrej-tropical-isle') }}"><i
                                        class="fa-solid fa-chevron-right"></i> Godrej Tropical Isle</a></li>
                            <li><a href="{{ url('/projects/eldeco-ballads-of-bliss') }}"><i
                                        class="fa-solid fa-chevron-right"></i> Eldeco Ballads of Bliss</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Col 3: Quick Links -->
                <div class="col-lg-2 col-md-6 col-6">
                    <div class="footer-widget widget-links">
                        ...
                        <ul class="footer-menu-list">
                            <li><a href="{{ url('about-us') }}"><i class="fa-solid fa-chevron-right"></i> Our
                                    Passion</a></li>
                            <li><a href="{{ url('projects') }}"><i class="fa-solid fa-chevron-right"></i> Explore
                                    Projects</a></li>
                            <li><a href="{{ url('blogs') }}"><i class="fa-solid fa-chevron-right"></i> Knowledge
                                    Base</a></li>
                            <li><a href="{{ url('careers') }}"><i class="fa-solid fa-chevron-right"></i> Join Our
                                    Journey</a></li>
                            <li><a href="{{ url('contact') }}"><i class="fa-solid fa-chevron-right"></i> Contact Us</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="office-location-list">
                            ...
                            <div class="office-location-card mb-3">
                                ...
                                <div>
                                    ...
                                    <a href="https://g.co/kgs/UtKoFqn" target="_blank" rel="noopener noreferrer"
        ...
        <div class="container">
            <div
                ...
                <p class="copyright-text mb-0">
                    &copy; 2026 <strong>360 PropGuide LLP</strong>. All Rights Reserved. Designed &amp; Developed with
                    <i class="fa-solid fa-heart text-coral"></i> by AdvertIQ
                </p>
