...
<div class="project-HeroSection container pt-5">
  <div class="row align-items-center">
    <div class="mb-3 col-md-6">
      ...
      <p class="text-secondary mb-0">{{$projects->location}}</p>
    </div>
    <div class="mb-3 mb-md-0 ms-auto col-md-auto">
        ...
        @if($projects->slug == 'prestige-bougainvillea-gardens')
			...
			<button type="button"
				class="btn customBtn orange rounded-3 mb-5"
      ...
      <div class="d-flex  mb-3 mb-md-0 w-100 ms-0">
        <div>
          <a rel="noopener noreferrer" target="_blank" href="tel:+919643020020" class="btn customBtn rounded-3 d-lg-none">Contact Sales</a>
        </div>
        <div class="ms-3 ">
  ...
  <div class="row hero-section" id="hero">
    ...
    <div class="col-12 d-block d-md-none">
      <div id="mobileProjectSlider" class="carousel slide" data-bs-ride="carousel">
        ...
        <button class="carousel-control-prev" type="button" data-bs-target="#mobileProjectSlider" data-bs-slide="prev">
          <span class="carousel-control-prev-icon custom-arrow" aria-hidden="true"></span>
          <span class="visually-hidden">Previous</span>
        </button>
        <button class="carousel-control-next" type="button" data-bs-target="#mobileProjectSlider" data-bs-slide="next">
      ...
      <div>
        ...
        <div class="section project-section" id="summary">
          ...
          <a href="{{ $projects->youtube_links }}" target="_blank" rel="noopener" class="youtube-link">
            ...
            Explore the Project in Action <i class="fab fa-youtube" style="color: #FF0000;"></i> Watch Now on YouTube!
          </a>
          @endif
        ...
        <div class="section project-section" id="key">
          <h3 class="h4 my-4 text-primary fw-bold">Key Insights</h3>
          <p class="mb-3">{!!$projects->key_insights!!}</p>
          <div class="row">
            <div class="col-6 col-md-5 mb-2 position-relative">
              <span>
                <span class="text-primary ml-2 rera-toggle rera-info" style="cursor:pointer;">
                  ...
                  <div class="rera-body">
                    ...
                    <div class="rera-grid">
                      <div class="rera-left">
                        ...
                        <p class="rera-no">  {{ !empty($rera['rera_no']) ? $rera['rera_no'] : $projects->rera_no }}</p>
                      </div>
            ...
            <div class="col-6 col-md-5 mb-2">
              <i class="fa-solid fa-chart-area me-2 text-primary"></i><span><span class="text-primary fw-bold">Property
            ...
            <div class="col-6 col-md-5 mb-2 text-capitalize">
              <i class="fa-solid fa-building me-2 text-primary"></i><span><span class="text-primary fw-bold">Project
		...
		@php
			$sqftPriceData = json_decode($projects->sqft_price, true);
			$floorPlans    = json_decode($projects->floor_plans_data, true);
			$priceValue    = floatval($sqftPriceData[0]['value'] ?? 0);
			$defaultPlan   = $floorPlans[0] ?? null;
			$superArea     = floatval($defaultPlan['super_area'] ?? 0);
		...
		<div class="py-5">
			...
			<div class="floorplan-tabs d-flex flex-wrap gap-2 mt-3" 
				 id="floor_tabs_{{ $projects->id }}">
			</div>
				...
				<div class="col-6 col-md-6 mb-3">
					<div class="price-box">
						...
						<div class="value" id="bsp_value_{{ $projects->id }}">
							{{ number_format($priceValue) }} / sq. ft
						</div>
					</div>
				</div>
				<div class="col-6 col-md-6 mb-3">
		...
		@if(!empty($projects->site_plans_images))
			<section class="siteplan-section py-5">
				<div class="container">
					<h2 class="section-title mb-4">{{ $projects->project_name }} Site Plan</h2>
		...
		<h2 class="h4 my-4 text-primary fw-bold">Download Project Legal Status</h2>
                  ...
                  <div class="row m-0 w-100 align-items-center">
                    ...
                    <div class="col-md-3 col-6">
                      <div class="">
                       <p class="m-0 text-center py-2 fs-4 text-primary"> Super area:</p>
                        <div class="fw-bold text-black"><p class="m-0 fw-bold">{{ $floorPlan['super_area'] }} sq. ft.</p></div>
                      </div>
                    </div>
                    @endif
                    ...
                    <div class="col-md-3 col-6">
                      <div class="">
                        ...
                        <div class="fw-bold text-black"><p class="m-0">{{ $floorPlan['carpet_area'] }} sq. ft.</p></div>
                      </div>
                    </div>
                    @endif
                    ...
                    <div class="col-md-3 col-6">
                      <div class="">
                        ...
                        <div class="fw-bold text-black"><p class="m-0">{{ $floorPlan['balcony_area'] }} sq. ft.</p></div>
                      </div>
                    </div>
                    @endif
                    ...
                    <div class="col-md-3 col-6">
                      <div class="">
                        ...
                        <div class="fw-bold text-black"><p class="m-0">{{ $floorPlan['length'] }} m</p></div>
                      </div>
                    </div>
                    @endif
                    ...
                    <div class="col-md-3 col-6">
                      <div class="">
                        ...
                        <div class="fw-bold text-black"><p class="m-0">{{ $floorPlan['width'] }} m</p></div>
                      </div>
                    </div>
                    @endif
                    ...
                    <div class="col-md-3 col-6">
                      <div class="">
                        ...
                        <div class="fw-bold text-black"><p class="m-0">{{ $floorPlan['total_area'] }} sq. yds</p></div>
                      </div>
                    </div>
                    @endif
		...
		<h2 class="h4 my-4 text-primary fw-bold">Download Brochure And Price List</h2>
        <div class="row g-3 align-items-center mb-3">

          <!-- Left button -->
          <div class="col-6 col-md-6">
            <button type="button" class="btn customBtn w-100 download-btn rounded-3 p-2" data-bs-toggle="modal"
              data-bs-target="#contactModal" data-project-id="{{ $projects->id }}" data-type="brochure">
          ...
          <!-- Right button -->
          <div class="col-6 col-md-6 text-md-end">
            <button type="button" class="btn customBtn w-100 w-md-auto download-btn rounded-3 p-2" data-bs-toggle="modal"
              data-bs-target="#contactModal" data-project-id="{{ $projects->id }}" data-type="price_list">
        ...
        <div class="possessions section project-section" id="possession">
          <h3 class="h4 my-4 text-primary fw-bold">Possessions</h3>
        ...
        <div class="section mb-3 project-section" id="faq" itemscope itemtype="https://schema.org/FAQPage">
          ...
          <div class="row p-4">
            ...
            <form method="POST" class="popupForm" action="{{route('contact-mail')}}">
              ...
              <div class="form-group input-group">
                ...
                <input type="tel" class="form-control" name="mobile" placeholder="Mobile*" maxlength="10"
              ...
              @endif
			    <div class="w-full"> <button type="submit" class="btn orange text-white mb-2 w-100 submitButton">Submit</button> </div>
        ...
        <div class="row p-4">
          ...
          <form method="POST" class="popupForm" action="{{route('contact-mail')}}">
            ...
            <div class="form-group input-group">
              ...
              <input type="tel" class="form-control mobile" name="mobile" placeholder="Mobile*" minlength="10"
            ...
            @endif
			<div class="w-full"> <button type="submit" class="btn orange text-white w-100  mb-2 submitButton">Submit</button> </div>
            <div class="w-full d-flex justify-content-between gap-2">
			  
			  <!-- WhatsApp Button -->
			  <a href="https://wa.me/919643020020?text={{ urlencode('I want brochure of ' . $projects->project_name) }}"
				 target="_blank" id="whatsapp-btn-3"
				 class="btn whatsapp text-white w-50 d-flex justify-content-center align-items-center"><i class="fab fa-whatsapp me-2"></i>
				WhatsApp
			  </a>
			  <a href="tel:919643020020"
				 class="btn orange text-white w-50 d-flex justify-content-center align-items-center">
        ...
        <form method="POST" id="popupFormDownload" action="{{ route('popup.download') }}">
          ...
          @endif
            ...
            <div class="w-full d-flex justify-content-between gap-2">
			  ...
			  <a href="tel:+919643020020" class="btn customBtn orange text-white w-50"><i class="fas fa-phone me-2"></i>Call Us</a>

			  <!-- WhatsApp Button (right) -->
			  <a href="https://wa.me/919643020020?text={{ urlencode('I want brochure of ' . $projects->project_name) }}"
				 target="_blank"
				 class="whatsapp text-white w-50 d-flex justify-content-center align-items-center" id="whatsapp-btn-2">
				<i class="fab fa-whatsapp me-2"></i> WhatsApp
			  </a>
			</div>
      </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        floorPlans.forEach((plan, index) => {
            ...
            btn.addEventListener('click', () => {
                document.querySelectorAll('.floorplan-tabs button').forEach(b => b.classList.remove('active'));
                btn.classList.add('active');

                const superArea = parseFloat(plan.super_area || 0);
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('.rera-toggle').forEach(function(toggle) {
      const panel = toggle.parentElement.querySelector('.rera-panel');
      if (!panel) return;
