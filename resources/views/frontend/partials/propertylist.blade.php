...
<div class="property-card mb-3" data-type="{{ $property->property_type }}" data-bhk="{{ $property->configuration }}"
    data-price="{{ $property->total_price }}" data-location="{{ $property->city }}">

    <!-- Property Images -->
    <div class="property-image">
        <div class="slider-container">
            <div id="propertyCarousel{{ $property->id }}" class="carousel slide slider" data-bs-ride="carousel"
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item slide {{ $key === 0 ? 'active' : '' }}">
                        <img src="{{ url('storage/'.$gallery) }}" alt="{{ $property->title }}">
                    </div>
                    @endforeach
                    @else
    ...
    <div class="price-section">
        <div class="price-info">
            <div>
                <p class="price m-0">{{ formatPrice($property->total_price) }}</p>
            </div>
