@if(!empty($projects) && count($projects) > 0)
    @foreach($projects as $project)
        @php
            $typologyDisplay = !empty($project->typology_text) ? $project->typology_text : (!empty($project->typology) && is_string($project->typology) ? $project->typology : 'Details on request');
                ...
                <div class="project-card__media">
                    ...
                    <div class="project-card__badges">
                        ...
                        <div class="project-card__badge-right">
                            @if($hasRera)
                                <span class="project-card__rera"><i class="fa-solid fa-circle-check" aria-hidden="true"></i> RERA</span>
                            @endif
                        </div>
                    </div>
                </div>
