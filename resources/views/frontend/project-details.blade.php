...
@push('schema')
    ...
    <script type="application/ld+json">
        ...
        "image" => env("APP_URL") . ('storage/' . $projects->hero_images),
    ...
    <div class="row hero-section" id="hero">
        <div class="col-md-6 d-none d-md-block p-1">
            <img class="w-100 h-100 object-fit-cover rounded-3 hero-main-img border border-1 border-light-subtle shadow-sm"
                src="{{url('storage/' . $projects->hero_images)}}" alt="{{$projects->project_name}}" />
        </div>
        <div class="col-md-6 d-none d-md-block p-1">
            <div class="row h-100 g-2">
                <div class="col-6 aspect2-1">
                    <img class="w-100 h-100 object-fit-cover rounded-3 hero-tile-img border border-1 border-light-subtle shadow-sm"
                       src="{{url('storage/' . $projects->amenities_images)}}"
                        alt="{{$projects->project_name}} - Amenities" />
                </div>
                <div class="col-6 aspect2-1">
                    <img class="w-100 h-100 object-fit-cover rounded-3 hero-tile-img border border-1 border-light-subtle shadow-sm"
                       src="{{url('storage/' . $projects->feature_image)}}"
                        alt="{{$projects->project_name}} - Features" />
                </div>
                <div class="col-6 aspect2-1">
                    <img class="w-100 h-100 object-fit-cover rounded-3 hero-tile-img border border-1 border-light-subtle shadow-sm"
                        src="{{url('storage/' . $projects->logo_image)}}"
                        alt="{{$projects->project_name}} - Logo" />
                </div>
                <div class="col-6 aspect2-1">
                    <img class="w-100 h-100 object-fit-cover rounded-3 hero-tile-img border border-1 border-light-subtle shadow-sm"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 border-0 shadow">
                ...
                <div class="modal-body d-flex gap-4 justify-content-center align-items-center py-4">
                    ...
                    <a href="#" onclick="copyToClipboard('{{ url('projects/' . $projects->slug) }}'); return false;"
    ...
    <div class="row my-4 justify-content-between position-relative">
            ...
            <div>
                ...
                <div class="section project-section" id="overview">
                    <div class="project-details-card mb-4">
                        <h3 class="h4 mb-4 fw-bold text-dark">{{$projects->project_name}}<span class="text-primary"> Overview</span></h3>
                        <div class="row g-3 g-md-4">
                            <!-- Left Column -->
                            <div class="col-12 col-md-6 d-flex flex-column gap-3">
                                @if(!empty($projects->developer_name))
                                    <div class="project-info-row d-flex align-items-center">
                                        <div class="info-icon-box flex-shrink-0 d-flex align-items-center justify-content-center me-3">
                                            <i class="fa-solid fa-user-tie"></i>
                                        </div>
                                        <div class="info-text-box flex-grow-1 min-w-0">
                                            <span class="info-label d-block mb-1">Developer</span>
                                            <span class="info-value d-block text-break">{{ $projects->developer_name }}</span>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if(!empty($projects->property_size))
                                    <div class="project-info-row d-flex align-items-center">
                                        ...
                                        <div class="info-text-box flex-grow-1 min-w-0">
                                            ...
                                            <span class="info-value d-block text-break">{{ $projects->property_size }}</span>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if(!empty($projects->typology_string))
                                    <div class="project-info-row d-flex align-items-center">
                                        ...
                                        <div class="info-text-box flex-grow-1 min-w-0">
                                            ...
                                            <span class="info-value d-block text-break">{{ $projects->typology_string }}</span>
                                        </div>
                                    </div>
                                @endif
                                    ...
                                    <div class="project-info-row d-flex align-items-center position-relative">
                                        ...
                                        <div class="info-text-box flex-grow-1 min-w-0">
                                            ...
                                            <div class="info-value d-flex align-items-center flex-wrap gap-1 min-w-0">
                                                <span class="rera-toggle rera-info text-break" style="cursor:pointer;">
                                                    <i class="fa-solid fa-circle-info me-1 flex-shrink-0"></i> {{ $projects->rera_no }}
                                                </span>

                                                <div class="rera-panel shadow" aria-hidden="true" role="dialog" aria-label="RERA details">
                                                    ...
                                                    <div class="rera-top-info">
                                                        <p>
                                                            ...
                                                            Source:
                                                            <a href="https://www.up-rera.in" target="_blank" rel="noopener noreferrer" class="normal-link">
                                                            ...
                                                            @foreach($rera_details as $rera)
                                                                <div class="rera-grid">
                                                                    <div class="rera-left">
                                                                        ...
                                                                        <p class="rera-phase">{{ !empty($rera['phase']) ? $rera['phase'] : '' }}</p>
                                                                        <p class="rera-no">
                                ...
                                @if(!empty($projects->location))
                                    <div class="project-info-row d-flex align-items-center">
                                        ...
                                        <div class="info-text-box flex-grow-1 min-w-0">
                                            ...
                                            <span class="info-value d-block text-break">{{ $projects->location }}</span>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if(!empty($projects->project_status))
                                    <div class="project-info-row d-flex align-items-center">
                                        ...
                                        <div class="info-text-box flex-grow-1 min-w-0 text-capitalize">
                                            ...
                                            <span class="info-value d-block text-break">{{ clean($projects->project_status) }}</span>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if(!empty($projects->launch_date))
                                    <div class="project-info-row d-flex align-items-center">
                                        ...
                                        <div class="info-text-box flex-grow-1 min-w-0">
                                            ...
                                            <span class="info-value d-block text-break">{{ $projects->launch_date }}</span>
                                        </div>
                                    </div>
                                @endif
                ...
                <div class="section project-section" id="key">
                    <div class="project-details-card mb-4">
                        <h2 class="h4 mb-3 fw-bold text-dark">{{$projects->project_name}}<span class="text-primary"> Key Insights</span></h2>
		...
		@endif
                    ...
                    @if(!empty($floorPlans) || !empty($projects->sqft_price) || !empty($projects->price))
                        <div class="price section project-section" id="price">
                            <div class="project-details-card mb-4">
                                ...
                                {{-- Desktop Table View --}}
                                <div class="unit-table-container d-none d-md-block mb-4" style="overflow-x: auto; border-radius: 8px; border: 1px solid #e2e8f0;">
                                    <table class="unit-config-table mb-0 w-100">
                                        ...
                                        <tbody>
                                            @foreach($floorPlans as $index => $plan)
                                                @php
                                                    $planTitle = !empty($plan['title']) ? $plan['title'] : 'Configuration ' . ($index + 1);
                                                    $planArea = !empty($plan['super_area']) ? $plan['super_area'] . ' sq.ft' : (!empty($plan['carpet_area']) ? $plan['carpet_area'] . ' sq.ft' : '—');
                                                ...
                                                <tr class="floor-btn clickable-row {{ $index == 0 ? 'active' : '' }}"
                                                    ...
                                                    <td class="text-end">
                                                        <button type="button" class="btn btn-sm btn-outline-primary rounded-pill px-3 py-1 fw-semibold fs-13" data-bs-toggle="modal" data-bs-target="#contactModal">
                                                            Get Quote
                                                        </button>
                                                    </td>
                                                </tr>
                                    ...
                                    @foreach($floorPlans as $index => $plan)
                                        ...
                                        <div class="mobile-unit-card floor-btn clickable-row {{ $index == 0 ? 'active' : '' }}"
                                            ...
                                            <div class="mt-3 text-end">
                                                <button type="button" class="btn btn-sm btn-primary w-100 rounded-2 py-2 fw-semibold fs-13" data-bs-toggle="modal" data-bs-target="#contactModal">
                                                    Get Exact Quote
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row text-center g-3">
                                        <div class="col-6">
                                            <div class="stat-highlight-box p-3 rounded-3 border bg-light">
                                                ...
                                                <div class="stat-value text-primary fw-bold fs-5" id="bsp_value_{{ $projects->id }}">
                                                    @if($priceValue)
                                        ...
                                        <div class="col-6">
                                            <div class="stat-highlight-box p-3 rounded-3 border bg-light">
                                                <div class="stat-label mb-1 text-muted fs-12">Starting From</div>
                                                <div class="stat-value text-dark fw-bold fs-5" id="total_value_{{ $projects->id }}">
                                                    @if(!empty($floorPlans[0]['price']))
                                                        {{ $floorPlans[0]['price'] }}
                ...
                <div class="section project-section" id="location">
                    <div class="project-details-card mb-4">
                        <h2 class="h4 mb-4 fw-bold text-dark">{{ $projects->project_name }} <span class="text-primary">Location</span></h2>
                ...
                @if(!empty($projects->site_plans_images))
                    <div class="section project-section" id="site-plan">
                        <div class="project-details-card mb-4">
                            <h3 class="h4 mb-4 fw-bold text-dark">{{ $projects->project_name }} <span class="text-primary">Site Plan</span></h3>
                ...
                <div class="section project-section" id="legal-status">
                    <div class="project-details-card mb-4">
                        <h3 class="h4 mb-4 fw-bold text-dark">{{ $projects->project_name }} <span class="text-primary">Legal Status</span></h3>
                ...
                <div class="section project-section" id="floor">
                    <div class="project-details-card mb-4">
                        <h2 class="h4 mb-4 fw-bold text-dark">{{ $projects->project_name }} <span class="text-primary">Floor Plan</span></h2>
                        <div class="floorPlans">
                            ...
                            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff;" class="swiper floorSwiper mb-3">
                                <div class="swiper-wrapper">
                                    @php
                                        $floorPlans = json_decode($projects->floor_plans_data, true);
                                    @endphp
                ...
                <div class="section project-section" id="brochure">
                    <div class="project-details-card mb-4">
                        <h2 class="h4 mb-4 fw-bold text-dark">{{ $projects->project_name }} <span class="text-primary">Brochure & Price List</span></h2>
                        <div class="row g-3 align-items-center">
                            <div class="col-6 col-md-6">
                                <button type="button" class="btn customBtn w-100 download-btn rounded-3 p-2"
                                    data-bs-toggle="modal" data-bs-target="#contactModal" data-project-id="{{ $projects->id }}"
                ...
                <div class="possessions section project-section" id="possession">
                    <div class="project-details-card mb-4">
                        <h2 class="h4 mb-4 fw-bold text-dark">{{ $projects->project_name }} <span class="text-primary">Possessions</span></h2>
                ...
                <div class="amenities section project-section" id="amenities">
                    <div class="project-details-card mb-4">
                        <h2 class="h4 mb-4 fw-bold text-dark">{{ $projects->project_name }} <span class="text-primary">Amenities</span></h2>
                        <div class="row g-3">
                ...
                @if(!empty($projects->site_plans_description))
                    ...
                    <div class="price section project-section" id="price-description">
                        <div class="project-details-card mb-4">
                            <h2 class="h4 mb-4 fw-bold text-dark">{{ $projects->project_name }} <span class="text-primary">Pricing Details</span></h2>
                ...
                <div class="possessions section project-section" id="developer">
                    <div class="project-details-card mb-4">
                        <h3 class="h4 mb-4 fw-bold text-dark">Developer <span class="text-primary">Background</span></h3>
                ...
                <div class="section mb-4 project-section" id="faq" itemscope itemtype="https://schema.org/FAQPage">
                            ...
                            @foreach($faqs as $index => $faq)
                                @if(!empty(trim($faq['question'] ?? '')) && !empty(trim($faq['answer'] ?? '')))
                                    @php
                                        $isOpen = ($index == 0);
                                    @endphp
                                    <div class="accordion-item faq-item-card mb-3 border rounded-3 overflow-hidden" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                                        <h3 class="accordion-header" id="faqHeading{{ $index }}">
                                            <button class="accordion-button faq-btn px-4 py-3 fw-bold text-dark {{ $isOpen ? '' : 'collapsed' }}" 
                                                    type="button" 
                                                    data-bs-toggle="collapse" 
                                                    data-bs-target="#faqCollapse{{ $index }}" 
                                                    aria-expanded="{{ $isOpen ? 'true' : 'false' }}" 
                                                    aria-controls="faqCollapse{{ $index }}">
                                                <span class="faq-question-text flex-grow-1 pe-3" itemprop="name">{{ trim($faq['question']) }}</span>
                                        ...
                                        <div id="faqCollapse{{ $index }}" 
                                             ...
                                             data-bs-parent="#projectFaqAccordion"
                                             itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                                            <div class="accordion-body faq-answer-text px-4 pb-4 pt-0 text-secondary" itemprop="text">
                                                {!! $faq['answer'] !!}
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="col-lg-4 col-md-10 order-1 order-lg-2 mx-auto me-lg-0 ms-lg-auto" id="sidebar-wrapper">
                ...
                <div class="d-none d-lg-block ppc-form col-md-8 mx-auto col-lg-12 mb-4" id="sidebar-enquiry-form">
                    <div class="p-4 pt-3">
                        <div class="text-center mb-3">
                            <span class="badge bg-primary-subtle text-primary fw-semibold px-3 py-1 rounded-pill mb-2" style="font-size: 0.75rem;">QUICK ENQUIRY</span>
                ...
                <div class="card shadow-sm border-0 rounded-3 p-4 d-none d-lg-block mt-0 sticky-recommended-card" id="sidebar-recommended-projects" style="border: 1px solid #e2e8f0 !important;">
                    ...
                    @foreach($recommendedProjects as $recommended)
                        <a class="col-12 d-block text-decoration-none mb-3" href="{{route('projects.details', $recommended->slug) }}">
                            <div class="recommended-card-wrapper d-flex align-items-stretch">
                                <div class="col-5 img-box position-relative">
                                    <img alt="{{$recommended->project_name }}" loading="lazy"
                                       ...
                                       src="{{url('storage/' . $recommended->logo_image) }}" />
                                </div>
                                <div class="p-3 col-7 d-flex flex-column justify-content-center min-w-0">
                                    <h3 class="recommended-title text-dark fw-bold mb-1 text-truncate" style="font-size: 0.92rem;">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const sections = Array.from(document.querySelectorAll('.project-section[id]')).filter(sec => {
            return (sec.id in sectionTitleMap) && (sec.offsetWidth > 0 || sec.offsetHeight > 0 || sec.getClientRects().length > 0);
        });
        ...
        sections.forEach((sec, idx) => {
            const id = sec.id;
            const title = sectionTitleMap[id] || (sec.querySelector('h2, h3')?.textContent?.trim() || id);
        ...
        navContainer.addEventListener('mouseleave', () => { isDragDown = false; });
        navContainer.addEventListener('mouseup', () => { isDragDown = false; });
        ...
        navContainer.addEventListener('click', function (e) {
            ...
            if (targetEl) {
                ...
                const targetPosition = targetEl.getBoundingClientRect().top + window.pageYOffset - totalOffset;
            ...
            if (!isScrollSpyTicking) {
                requestAnimationFrame(() => {
                    ...
                    if (navWrapper) {
                        ...
                        if (overviewEl) {
                            const currentNavbarHeight = document.getElementById('navbar')?.offsetHeight || 80;
        ...
        document.querySelectorAll('.floor-btn').forEach(btn => {
            ...
            btn.addEventListener('click', function () {
                ...
                if (planIndex !== undefined) {
                    document.querySelectorAll(`.floor-btn[data-plan-index="${planIndex}"]`).forEach(b => b.classList.add('active'));
                } else {
