...
<div class="container">
    <div class="row my-4 gx-lg-5 justify-content-between position-relative">
        <div class="col-lg-8 col-md-12 order-2 order-lg-1">
            ...
            <div class="project-info-card card border border-light-subtle shadow-sm rounded-3 p-2 p-md-3 mb-4 bg-white">
                ...
                <div
                    ...
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        ...
                        <button type="button" class="btn btn-outline-secondary rounded-3 px-3" data-bs-toggle="modal"
            ...
            <div>
                ...
                <div class="section project-section" id="overview">
                    <div class="project-details-card mb-4">
                        <h3 class="h4 mb-4 fw-bold text-dark">{{ $projects->project_name }}<span class="text-primary">
                                Overview</span></h3>
                    ...
                    <div class="project-details-card mb-4">
                        ...
                        <div class="mt-3">
                            <a href="{{ $projects->youtube_links }}" target="_blank" rel="noopener"
                                ...
                                Explore the Project in Action <i class="fab fa-youtube" style="color: #FF0000;"></i>
                                Watch Now
                                on YouTube!
                            </a>
                        </div>
                ...
                <div class="section project-section" id="key">
                    <div class="project-details-card mb-4">
                        <h2 class="h4 mb-3 fw-bold text-dark">{{ $projects->project_name }}<span class="text-primary">
                                Key Insights</span></h2>
    ...
    @endif
                ...
                <div class="section project-section" id="location">
                    <div class="project-details-card mb-4">
                        ...
                        <div class="mb-3 rounded-3 overflow-hidden">
                            <video src="{{ storageUrl($projects->location_video) }}" class="w-100" autoplay muted
                                controls></video>
                        </div>
                        @endif
                ...
                <div class="section mb-4 project-section" id="faq" itemscope itemtype="https://schema.org/FAQPage">
                    ...
                    <div class="accordion custom-faq-accordion" id="projectFaqAccordion">
                        ...
                        $isOpen = $index == 0;
                        @endphp
                        <div class="accordion-item faq-item-card mb-3 border rounded-3 overflow-hidden" itemscope
                            ...
                            <div id="faqCollapse{{ $index }}"
                                ...
                                aria-labelledby="faqHeading{{ $index }}" data-bs-parent="#projectFaqAccordion" itemscope
