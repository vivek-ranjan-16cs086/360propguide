...
property, real estate company in noida, property greater noida, property in greater noida west, property in gr noida")
@section('priority')
@endSection
        ...
        <div class="hero-content">
            <div class="container">
                ...
                <p class="hero-lead" id="heroLead"
                    ...
                    data-lead-commercial="Shops and commercial spaces across Delhi NCR">
                    {{ $heroCountLabel($heroProjectCount) }} verified projects and 100% RERA checked listings
                </p>

                <div class="hero-search-panel">
                    <div class="hero-tabs" role="tablist" aria-label="Search type">
                        <button type="button" class="hero-tab is-active" role="tab" aria-selected="true"
                            data-mode="projects">Projects</button>
                        <button type="button" class="hero-tab" role="tab" aria-selected="false"
                            data-mode="properties">Buy</button>
                        <button type="button" class="hero-tab" role="tab" aria-selected="false"
                            data-mode="commercial">Commercial</button>
                    </div>

                    <div class="hero-search searchboxs" data-search-mode="projects">
                        <div class="hero-search__city" id="heroCityPicker">
                            <button type="button" class="hero-city-trigger" id="heroCityTrigger" aria-haspopup="listbox"
                                aria-expanded="false" aria-controls="heroCityMenu">
                            ...
                            <select class="hero-search__native" name="location" id="heroLocation" tabindex="-1"
                                aria-hidden="true">
                        ...
                        <select class="hero-search__native" name="bhkType" id="heroBhk" tabindex="-1"
                            aria-hidden="true">
                            <option value=""></option>
            ...
            <div class="projects-section-card">
                <div
                    ...
                    <div>
                        ...
                        <p class="section-subtitle">Handpicked projects across Noida, Greater Noida West, Yamuna
                            Expressway & Dehradun — RERA-verified, transparent pricing, trusted builders.</p>
                    </div>
                                    ...
                                    <div class="projectDescp">
                                        ...
                                        <div class="project-card__footer">
                                            <p class="price">
                                                ...
                                                @if(!empty($project->max_price) && $project->price !=
                                                $project->max_price)
        ...
        <div class="container">
            <div class="tools-section-card">
                <div class="section-header-wrap">
                    ...
                    <p class="section-subtitle">Plan smarter with free EMI, budget & loan eligibility calculators — make
                        confident,
                        ...
                        <a href="{{ route('blogs.details', $blog->slug) }}" class="project-card-link">
                            <div class="blog-card">
                                <div class="blog-card__img-wrap">
                                    <img src="{{ env('APP_URL').'storage/' . $blog->featured_image }}"
        ...
        <div class="expert-consult-banner">
            <div class="row align-items-center g-4">
                <div class="col-lg-7">
                    ...
                    <h3 class="consult-headline">Looking for the Best Property in Noida, Delhi NCR? Talk to Our Experts
                    </h3>
                    <p class="consult-subtext">Confused which property suits your budget? Get free, unbiased advice and
