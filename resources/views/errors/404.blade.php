...
@section('customCSS')
<link rel="stylesheet" href="{{url('frontend/css/not-found.css')}}" />
@endSection

@section('content')
<a target="_blank" href="https://360propguide.com/">
    <div class="container">
        <div class="row">
                ...
                <svg width="100%" height="auto" viewBox="0 0 636 324" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <defs>
                        ...
                        <linearGradient id="paint6_linear" x1="197.311" y1="242.736" x2="195.989" y2="148.447"
                            ...
                            <stop offset="1" stop-color="#1b3f63" />
                        </linearGradient>
...
@endSection
@section('customJS')
<script href="{{url('frontend/js/not-found.js')}}" />
@endSection